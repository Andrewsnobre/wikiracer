...
const cheerio_1 = __importDefault(require("cheerio")); // Importing cheerio for parsing HTML
...
function getLinks(page) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const $ = cheerio_1.default.load(response.data); // Load the HTML response with cheerio
